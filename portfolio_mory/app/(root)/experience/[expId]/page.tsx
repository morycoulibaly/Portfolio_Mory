...
export async function generateMetadata({
  ...
  return {
    title: `${experience.position} chez ${experience.company} | Experience`,
    description: `Details de mon role ${experience.position} chez ${experience.company}.`,
    alternates: {
        ...
        <AnimatedSection delay={0.3}>
          <div>
            ...
            <p className="mt-4 text-sm text-muted-foreground">
              Voici les principales technologies et competences utilisees dans
              ce contexte chez {experience.company}.
            </p>
          </div>
        </AnimatedSection>
      ),
