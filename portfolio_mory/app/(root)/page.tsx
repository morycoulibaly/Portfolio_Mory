...
export const metadata: Metadata = {
  ...
  description:
    "Portfolio de Mory Coulibaly, developpeur Fullstack Junior base a Abidjan. Projets, competences, experience et contact pour stage, alternance ou opportunite junior.",
  alternates: {
...
export default function IndexPage() {
  ...
  const personSchema = {
    ...
    jobTitle: "Developpeur Fullstack Junior",
    address: {
      "@type": "PostalAddress",
    ...
    sameAs: [
      ...
      "https://www.linkedin.com/in/morycoulibaly",
    ],
  };
        ...
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center -mt-20">
          ...
          <div className="flex flex-col mt-10 items-center justify-center sm:flex-row sm:space-x-4 gap-3">
            <AnimatedText delay={0.6}>
              ...
              >
                <Icons.post className="w-4 h-4 mr-2" /> CV
              </Link>
            </AnimatedText>
            <AnimatedText delay={0.8}>
              <Link
                ...
                aria-label="Contacter Mory Coulibaly"
              >
